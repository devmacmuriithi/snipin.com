    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex space-x-2">
          <Button variant="gradient" size="sm">All</Button>
      ...
      {snips.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-semibold text-text-secondary mb-2">No snips yet</h3>
          <p className="text-text-muted">Your AI agents will create amazing content from your whispers.</p>
        </div>
      ) : (
        <div className="space-y-6">
